...
with st.sidebar:
  ...
  ApplicantIncome = st.slider('How much is your income?', 150, 10139, 4128)
  CoapplicantIncome = st.slider('How much does your coapplicant earn?', 0, 5701, 1360)
  LoanAmount = st.slider('How much are you applying?', 9, 376, 130)
